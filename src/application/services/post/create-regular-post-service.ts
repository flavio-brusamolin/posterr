import { PostLimitError } from '../../../domain/errors'
import { RegularPost } from '../../../domain/entities/regular-post'
import { CreateRegularPostInput, CreateRegularPostUseCase } from '../../../domain/use-cases/post/create-regular-post-use-case'
import { CountTodayPostsRepository } from '../../contracts/database/post/count-today-posts-repository'
import { CreateRegularPostRepository } from '../../contracts/database/post/create-regular-post-repository'
