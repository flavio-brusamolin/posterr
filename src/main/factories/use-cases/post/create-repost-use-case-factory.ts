...
import { CreateRepostService } from '../../../../application/services/post/create-repost-service'
...
export const makeCreateRepostUseCase = (): CreateRepostUseCase => {
  ...
  const createRepostService = new CreateRepostService(postMongoRepository, postMongoRepository, uuidAdapter, postMongoRepository)
